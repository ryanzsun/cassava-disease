...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.bn1 = nn.BatchNorm1d(num_features*2, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fc = nn.Linear(num_features*2, 1024)
    ...
    def forward(self, x):
        ...
        out = torch.cat((self.avg_pool(out), self.max_pool(out)), 1)
